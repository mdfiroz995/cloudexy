<x-app-layout>
                    ...
                    <form method="POST" action="{{ route('admin.posts.update', $post->id) }}"
                                    ...
                                    <div class="" x-data="imageData3()">
                                        <div x-show="previewUrl == '' && imgurl == ''">
                                            <p class="text-center uppercase text-bold">
                                                ...
                                                <input type="file" name="postimg" id="thumbnailprev"
                        ...
                        <div id="">
                            <div class="flex flex-col space-y-2" id="editor1" >
                                ...
                                <textarea name="long_description" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200"
                                rows="5"> {{ $post->long_description }}</textarea>
                            </div>
                        </div>
    ...
    <script>
        function imageData3() {
            ...
            if (files.length == 0) {
                var url = '/blogimages/' + {!! json_encode($post->postimg) !!};
            } else {
                url = '';
            }
            return {
