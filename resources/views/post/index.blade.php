              ...
              @can('Post access')
                ...
                <tr class="hover:bg-grey-lighter">
                  ...
                  <td class="py-4 px-6 border-b border-grey-light text-right">
                    ...
                    @can('Post edit')
                    <a href="{{route('admin.posts.edit',$post->id)}}" class="text-grey-lighter font-bold py-1 px-3 rounded text-xs bg-green hover:bg-green-dark text-blue-400"><i class="far fa-edit"></i></a>
                    @endcan
