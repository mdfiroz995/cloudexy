@php $title = "Search Result" @endphp
...
{{-- <div class="container" >
    <span class="n404">4</span>

    <div class="planet_404_wrapper">
        <div class="planet_404_front"></div>
        <div class="planet_404_ring"></div>
        <div class="planet_404_back"></div>
    </div>
