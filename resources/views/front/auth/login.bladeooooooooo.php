...
<div class="fluid-container"  style="background-image:url(images/1.jpg); position: relative;
...
background-repeat: no-repeat; opacity: 0.85;">
    <div class="wrapper">
        ...
        <div class="text-center mt-5 name">
          ...
          <!-- Session Status -->
          <x-auth-session-status class="mb-4 text-center text-danger" :status="session('status')" />

          <!-- Validation Errors -->
          <x-auth-validation-errors class="mb-4 text-center text-danger custom"  :errors="$errors" />
