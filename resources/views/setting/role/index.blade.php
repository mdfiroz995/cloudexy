                    ...
                    @can('Role access')
                      ...
                      <tr class="hover:bg-grey-lighter">
                        ...
                        <td class="py-4 px-6 border-b border-grey-light text-right">
                          ...
                          @can('Role edit')
                          <a href="{{route('admin.roles.edit',$role->id)}}" class="text-grey-lighter font-bold py-1 px-3 rounded text-xs bg-green hover:bg-green-dark text-blue-400"><i class="far fa-edit"></i></a>
                          @endcan
